defmodule PkyWeb.Live.Components.IndexCarousel.CarouselSteam do
  ...
  def game_card(assigns) do
    ~H"""
    <div class="bg-gray-800/50 rounded-lg p-3 w-full max-w-sm border border-gray-700">
        ...
        <div class="flex flex-col justify-center min-w-0 flex-1">
          ...
          <div class="flex flex-col gap-0.5">
            <div class="flex items-center justify-between text-xs">
              ...
              <span class="text-gray-250 font-mono">
                {format_hours(@game.playtime_2weeks_minutes)}
              </span>
            </div>
            ...
            <div class="flex items-center justify-between text-xs">
              ...
              <span class="text-gray-300 font-mono">
                {format_hours(@game.playtime_forever_minutes)}
              </span>
            </div>
          </div>
        </div>
